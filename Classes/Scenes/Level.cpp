...
bool Level::init()
{
    ...
    auto labelEasyLevel = Label::createWithTTF(LanguageManager::getLocalizedText("Level", "easy"), MainBoldFont, 70.0);
    ...
    labelEasyLevel->setTextColor(IkasBlue);
    ...
    auto labelMediumLevel = Label::createWithTTF(LanguageManager::getLocalizedText("Level", "medium"), MainBoldFont, 70.0);
    ...
    labelMediumLevel->setTextColor(IkasBlue);
    ...
    auto labelHardLevel = Label::createWithTTF(LanguageManager::getLocalizedText("Level", "hard"), MainBoldFont, 70.0);

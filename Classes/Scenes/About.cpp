...
bool About::init()
{
    ...
    auto labelAboutTitle = Label::createWithTTF(LanguageManager::getLocalizedText("About", "title"), MainBoldFont, 140);
    labelAboutTitle->setAlignment(TextHAlignment::LEFT);
    labelAboutTitle->setAnchorPoint(Point::ANCHOR_MIDDLE_LEFT);
    labelAboutTitle->setTextColor(IkasBlue);
    ...
    labelAbout = Label::createWithTTF(LanguageManager::getLocalizedText("About", "information"), MainBoldFont, 50);
    labelAbout->setWidth(ScreenSizeManager::getWidthFromPercentage(InfoLabelMaxWidthPercentage));
    labelAbout->setTextColor(IkasBlue);

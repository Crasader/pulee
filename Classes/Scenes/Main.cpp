...
//    GamePlayPointsManager::getInstance()->resetCurrentGamePlaySettings();
    ...
    background->setScale(this->getContentSize().width / background->getContentSize().width, this->getContentSize().height / background->getContentSize().height);
    ...
    auto labelPlay = Label::createWithTTF(LanguageManager::getLocalizedText("Main", "play"), MainBoldFont, 70);
    labelPlay->setAlignment(TextHAlignment::CENTER);
    labelPlay->setAnchorPoint(Point::ANCHOR_MIDDLE_TOP);
    labelPlay->setTextColor(IkasBlue);
    ...
    _labelLoadingAnimation = Label::createWithTTF(LanguageManager::getLocalizedText("Main", "loading"), MainBoldFont, 60);
    _labelLoadingAnimation->setAlignment(TextHAlignment::CENTER);
    _labelLoadingAnimation->setAnchorPoint(Point::ANCHOR_MIDDLE_TOP);
    _labelLoadingAnimation->setTextColor(Color4B(IkasBlue.r, IkasBlue.g, IkasBlue.b, 130));

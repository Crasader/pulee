...
bool Lose::init()
{
    ...
    auto labelResume = Label::createWithTTF(LanguageManager::getLocalizedText("Lose", "reset"), MainBoldFont, 70);
    ...
    totalPoints << GamePlayPointsManager::getInstance()->getCurrentMatchPoints() << " " << LanguageManager::getLocalizedText("Lose", "points-value");

    auto labelPointsValue = Label::createWithTTF(totalPoints.str(), MainBoldFont, 75);
    labelPointsValue->setAlignment(TextHAlignment::CENTER);
    labelPointsValue->setAnchorPoint(Point::ANCHOR_MIDDLE);
    labelPointsValue->setTextColor(IkasBlue);
    ...
    auto labelPointsTitle = Label::createWithTTF(LanguageManager::getLocalizedText("Lose", "points-title"), MainBoldFont, 75);
    ...
    auto labelTitle = Label::createWithTTF(LanguageManager::getLocalizedText("Lose", "title"), MainBoldFont, 90);
    labelTitle->setAlignment(TextHAlignment::CENTER);
    labelTitle->setAnchorPoint(Point::ANCHOR_MIDDLE);
    labelTitle->setTextColor(IkasYellow);
    ...
    Vec2 _editNameposition = buttonEditName->getPosition();
    _usernameBox->setPosition(_editNameposition);
    _usernameBox->setFontName(MainBoldFont.c_str());
    _usernameBox->setFontSize(100);
    _usernameBox->setFontColor(Color3B(IkasBlue));
    _usernameBox->setPlaceHolder(LanguageManager::getLocalizedText("Lose", "name").c_str());
    _usernameBox->setPlaceholderFontSize(20);
    _usernameBox->setPlaceholderFontColor(Color3B(IkasBlue));
    ...
    auto sendPointsLabel = Label::createWithTTF(LanguageManager::getLocalizedText("Lose", "sendPoints"), MainBoldFont, 30);
